...
local function open_file()
  local str = string.gsub(api.nvim_get_current_line(), "%s+", "")
  local root = string.gsub(api.nvim_call_function("system", { "git rev-parse --show-toplevel" }), "%s+", "")
  local fname = path_join(root, str)
  close_window()
